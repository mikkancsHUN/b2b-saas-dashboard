...
const handleLogin = async (e: React.FormEvent) => {
  ...
  return (
    <>
      <div className="mb-6">
        <h2 className="text-xl font-bold text-gray-900 dark:text-white">Üdvözlünk újra!</h2>
        <p className="text-xs text-gray-400 mt-1">Lépj be a fiókodba a folytatáshoz.</p>
      </div>
    ...
    >
      ...
      <div className="mt-6 text-center border-t border-gray-100 dark:border-gray-800 pt-4">
        <p className="text-xs text-gray-400">
          Még nincs fiókod?{' '}
          <Link href="/register" className="text-indigo-500 hover:text-indigo-400 font-bold">
            Regisztrálj most
          </Link>
        </p>
      </div>
